    ...
    <section class="u-bg-overlay g-bg-pos-top-center g-bg-img-hero g-bg-black-opacity-0_3--after g-py-100"
        ...
        <div class="container u-bg-overlay__inner">
            <div class="row justify-content-center text-center mb-5">
                <div class="col-lg-8">
                    <h1 class="g-color-white text-uppercase mb-4">Login or Signup</h1>
            ...
            <div class="row justify-content-center align-items-center no-gutters">
                ...
                <div class="col-lg-5 g-bg-white g-rounded-right-5--lg-up">
                    <div class="g-pa-50">
                        <form class="g-py-15">
                            <h2 class="h3 g-color-black mb-4">Sign Up</h2>
                            <p class="mb-4">Sign up for the best data, recharge, subscription and more deals</p>
