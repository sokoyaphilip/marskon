    ...
    <div class="g-pa-20">
        ...
        <div class="row">
            <div class="col-md-3 col-xs-12">
                <div class="row">
                    <div class="col-md-12 col-xs-6 g-mb-30">
                        <div class="card g-brd-lightred-v3 text-center g-pa-15 g-pa-25-30--md">
                            <header class="media g-mb-40">
                                <h3 class="d-flex align-self-center text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">
                                    Transact Coins</h3>
                            ...
                            <section class="row">
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-lightyellow g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            Bit Coin
                                        </strong>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-lightblue-v6 g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            Paxfull
                                        </strong>
                                    </div>
                            ...
                            <section class="row g-mt-10">
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-gray-light-v9 g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            Ethereum
                                        </strong>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-gray-light-v1 g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            Other Coins
                                        </strong>
                                    </div>
                    ...
                    <div class="col-md-12 col-xs-6 g-mb-30">
                        <div class="card g-brd-darkblue-v5 text-center g-pa-15 g-pa-25-30--md">
                            ...
                            <section class="row">
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-black-opacity-0_4 g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            Amazon
                                        </strong>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-pink-v2 g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            iTunes
                                        </strong>
                                    </div>
                            ...
                            <section class="row g-mt-10">
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-bluegray g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            Verizon
                                        </strong>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="g-brd-top g-brd-2 g-brd-teal g-pt-18">
                                        <strong class="d-block g-line-height-1 g-font-weight-500 g-font-size-18 g-color-black g-mb-8--sm">
                                            Other Cards
                                        </strong>
                                    </div>
                        ...
                        <div class="d-flex g-ml-15 g-ml-55--md">
                            <div class="input-group g-pos-rel g-width-320--md">
                                <input id="datatableSearch1"
                                       ...
                                       type="text" placeholder="Search for a transaction">
                    ...
                    <div class="table-responsive">
                        <table class="js-datatable table u-table--v3 u-editable-table--v1 g-color-black"
                          ...
                          Wallet Funding
                                ...
                                <td> Wallet Funding using Paystack Payment Method</td>
                                <td>N2,000</td>
                                <td>
