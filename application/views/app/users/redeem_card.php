            ...
            <div class="col-sm-4">
                <div class="row g-mt-10">
                    <div class="col-sm-12 g-mt-10">
                        <h4 class="h6 g-font-weight-600 g-color-black g-mb-20">To Redeem Any Gift Card to Your Wallet
                            Complete The Form
                            Below</h4>
                        <div class="form-group u-select--v3 g-pos-rel g-brd-gray-light-v7 g-rounded-25 mb-0">
                            <div class="dropdown bootstrap-select js-select u-select--v3-select u-sibling w-100 dropup">
                                <select
                                        ...
                                        title="Select Gift Card" style="display: none;" tabindex="-98">
                      ...
                      <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
	                  	<i class="fa fa-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                ...
                                <input id="inputGroup-3_1"
                                       ...
                                       type="text" placeholder="Amount on Card (&#8358;)">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12">
                      ...
                      <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
	                  	<i class="fa fa-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                ...
                                <input id="inputGroup-3_1"
                                       class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-20 g-px-14 g-py-10"
                                       type="text" placeholder="Number of Cards (1)">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 g-mt-10">
                <textarea id="inputGroup-3_3"
                          ...
                          rows="3"
                          placeholder="Enter The Gift Card Number Here, Separate Numbers wth (,) for multiple Gift Cards."></textarea>
                    </div>
                    <div class="col-sm-12 g-mt-10 text-right">
                        <a class="js-fancybox btn btn-xl u-btn-primary g-rounded-20 g-font-size-default g-ml-10"
