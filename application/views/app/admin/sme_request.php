<?php $this->load->view('landing/admin_header'); ?>
    <div class="g-pa-20" style="min-height: calc(92vh - 67px);">
        ...
        <div class="g-pa-20 col-md-12">
            <h1 class="g-font-weight-300 g-font-size-28 g-color-black g-mb-30">Approve / Decline SME Request
                Request</h1>
                        ...
                        <tbody>
                            <?php foreach( $requests as $request ): ?>
                                <tr>
                                    ...
                                    <td><?= $request->phone; ?></td>
                                    <td><?= neatDate( $request->date_initiated) . ' ' . neatTime($request->date_initiated); ?></td>
                                    <td><?= payment_id_replacer($request->description); ?></td>
                                    <td><?= ngn($request->amount)?></td>
                                    <td>
                                        <form class="form-inline" method="post" action="<?= base_url('admin/sme_request')?>" id="<?= $request->id?>">
